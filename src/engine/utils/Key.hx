...
class Key
{
	...
	public inline static var NUMPAD_DOT = 110;
	public inline static var NUMPAD_DIV = 111;
	public inline static var NUMPAD_ENTER = 108;
	public inline static var NUMPAD_MUL = 106;
	public inline static var NUMPAD_SUB = 109;
